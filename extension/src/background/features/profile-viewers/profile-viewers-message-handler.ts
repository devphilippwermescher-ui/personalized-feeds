...
import { queueProfileAnalyticsForLinkedInActivity } from '../profile-analytics/profile-analytics-sync-coordinator';
...
export function registerProfileViewersMessageHandler(): void {
      ...
      getAuthenticatedFeedsUser()
        .then((user) => {
          ...
          return Promise.all([
            ...
            const projectedViewers = visibleViewerLimit === null ? viewers : viewers.slice(0, visibleViewerLimit);
