import type { LinkedInConnectionRecord, LinkedInConnectionsRscPage } from '../types';
import { readConnectionDateOccurrences, type ConnectionDateOccurrence } from './connection-date-parser';
